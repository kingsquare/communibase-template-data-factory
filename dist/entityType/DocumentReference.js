...
module.exports = {
  _getTitlePromise: function _getTitlePromise(titleFields, entityTypeTitle, document) {
    var self = this;
  ...
  getPromiseByPaths: function getPromiseByPaths(entityTypeTitle, document, requestedPaths, parents) {
    ...
    return BaseSerializer.getPromiseByPaths.apply(this, arguments).then(function (templateData) {
      ...
      var parentPromise = rootDocumentEntityTypeNibbles[0] === 'parent' ? Promise.resolve(parents[rootDocumentEntityTypeNibbles.length - 1]) : self.cbc.getById(document.rootDocumentEntityType, document.rootDocumentId);
      return parentPromise.then(function (parent) {
        var parentType = rootDocumentEntityTypeNibbles[0] === 'parent' ? parent.__cb_type__ : document.rootDocumentEntityType;
