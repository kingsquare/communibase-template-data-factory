...
var formatSubscriberNumber = function formatSubscriberNumber(subscriberNumber) {
...
module.exports = {
   ...
   * @return {string}
   */
  composeTitle: function composeTitle(chunks, entityTypeTitle, document) {
    if (chunks.length > 2) {
  ...
  getPromiseByPaths: function getPromiseByPaths(entityTypeTitle, phoneNumber, requestedPaths, parents) {
